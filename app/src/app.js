...
export function pages({ register, post, gql, postWebpage, load, loadState }) {
  ...
  async function create(page, notify) {
    ...
    return Async.of(page)
      ...
      .chain(page =>
        Async.of(page).map(({ title, creator, code, description, widgets, html, theme, includeFooter, state }) => ({
          title,
          description,
          html: htmlTemplate(title, creator, code, description, widgets, html, theme, includeFooter),
          state,
          creator,
          code
...
function htmlTemplate(title, creator, code, description, widgets, body, theme = "default", includeFooter) {
